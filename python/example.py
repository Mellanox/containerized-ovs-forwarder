...
def main():
    ...
    try:
        ...
        container_ovs = ovsdb_lib.BaseOVS(connection='tcp:127.0.0.1:6000')

        host_ovs = containerovsdb_lib.BaseOVS(connection='tcp:127.0.0.1:6001')
        # Add bridge to ovs
        container_ovs.add_ovs_bridge("br0-ovs", "netdev")

        # Create vdpa port
        container_ovs.create_vdpa_port("br0-ovs",
                            "vdpa0",
        ...
        host_ovs.create_ovs_vif_port(host_bridge_name, "enp2s0f1_0")
